...
######## advtrain ###########
python3 src/main.py --gen-num-layers 1 --gen-model-type lstm --freeze-cnn 0 --num-workers 8 --data-dir ../coco_data --save-dir save --pretrain-lr 1e-4 --pretrain-epochs 0 --gen-lr 1e-4 --disc-lr 1e-4 --adv-epochs 100 --dataset_percent 0.1 --expt-name lstm-bidirectional-adv-train-0.1 --captions-per-image 5 --advtrain-patience 12 --pretrain-lr-patience 4 --conditional-gan 0 --adv-train-batch-size 32 --adv-loss-type standard 
########3 pretrain - adv #########
